    ...
    <div class="mx-auto col col-12 col-sm-11 col-md-9 col-lg-7 col-xl-6">
      <div class="card mt-3">
        <div class="card-body text-center">
          ...
          <br>
          <a class="btn btn-outline-success btn-rounded" data-mdb-ripple-color="dark" href="{{ route('login.guest') }}">
            ゲストログイン
          </a>

          <a href="{{ route('login.{provider}', ['provider' => 'google']) }}" class="btn btn-outline-danger" data-mdb-ripple-color="dark" style="text-transform:capitalize;">
